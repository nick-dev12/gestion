...
<section class="section2 ste" id="ste">
    ...
    <div class="container">
        ...
        <div class="box1">
            ...
            <img class="affiche" src="/image/profil.png" alt="">
            <span></span>
        ...
        <div class="box3">
            <ul>
                ...
                <a href="../page/delete.php">
                    <li class="tr4"><img src="../image/Netflix 2.png" alt=""> <span class="td">Netflix</span></li>
                </a>

                <a href="/index.php">
                    <li class="tr"><img src="../image/prime video.png" alt=""> <span class="td">Prime Video</span></li>
                </a>

                <a href="../page/expiration.php">
                    <li class="tr1"><img src="../image/Crunchyroll 2.png" alt=""><span class="td">Crunchyroll</span>
                    </li>
                </a>
...
<section class="section2 menu" id="menu">
    ...
    <div class="container">
        <div class="box1">
            ...
            <img class="affiche" src="/image/logo.jpeg" alt="">
            <span></span>
